...
import {
  ...
  Flame, Tv, Radio, Mountain, Anchor, Megaphone, SlidersHorizontal, MapPinned
} from 'lucide-react';
...
const LAYER_GROUPS: LayerGroupDef[] = [
  {
    label: 'SIAP',
    fullLabel: 'SIAP • INSPECCIONES MANTA',
    icon: MapPinned,
    layers: [
      { key: 'siap_routes', label: 'Recorridos (moto / a pie)', dataKey: 'siap_inspectors' },
      { key: 'siap_points', label: 'Puntos inspección', dataKey: 'siap_points' },
    ],
  },
  {
    label: 'SDK',
              ...
              >
                <Icon
                  ...
                  style={{
                    width: 16,
                    height: 16,
                    color: group.label==='SIAP' && groupActive
                      ? '#17A7D2'
                      : groupActive
                    ...
                    filter: groupActive ? (group.label==='SIAP' ? 'drop-shadow(0 0 6px rgba(23,167,210,0.6))' : 'drop-shadow(0 0 4px rgba(255,255,255,0.3))') : 'none',
                  }}
                />
