  ...
  return (
    <>
      <button 
        ...
        className="pointer-events-auto glass-panel px-3 py-1.5 flex items-center gap-2 text-[9px] font-mono tracking-widest hover:opacity-80 transition-opacity border-[#17A7D2]/40 bg-[#17A7D2]/10 ml-3 shadow-[0_0_10px_rgba(23,167,210,0.1)]"
      >
        <TrendingUp className="w-3 h-3 text-[#17A7D2]" />
        <span className="text-[#17A7D2] font-bold">GAIA · SIAP</span>
      </button>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--border-primary)] bg-black/40">
                <div className="flex items-center gap-3">
                  <TrendingUp className="w-4 h-4 text-[#17A7D2]" />
                  <h2 className="text-xs font-mono font-bold text-white tracking-widest uppercase">GAIA SIAP — altura.com.ec</h2>
                </div>
                <button 
                  onClick={() => setIsOpen(false)}
